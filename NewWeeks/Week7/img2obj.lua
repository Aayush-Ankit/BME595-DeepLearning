...
local net = require 'mymodels/alexnet'
net:cuda()
...
--[[
      ...
      for i = 1,testset_size do
         ...
         local label_cv_tt = label_cv_t[{{}, i}]
         data = data:cuda()
         label_cv_tt = label_cv_tt:cuda()
         cv_out[{{}, i}] = net:forward(data)
         cv_error[j] = loss:forward(cv_out[{{}, i}], label_cv_tt)
      end
