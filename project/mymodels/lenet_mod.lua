...
-- first layer
net:add(nn.SpatialConvolution(in_dim,6,3,3))
...
-- third layer
net:add(nn.SpatialConvolution(16,36,4,4))
net:add(nn.SpatialMaxPooling(2,2,2,2))
net:add(nn.Tanh())
...
-- output layer
net:add (nn.Linear(out_size[1]*out_size[2]*out_size[3], 240))
net:add(nn.Tanh())
net:add (nn.Linear(240, 160))
net:add(nn.Tanh())


-- final layer
net:add(nn.Linear(160, num_class))
